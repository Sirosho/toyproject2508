...
public class TravelLogController {
    ...
    /**
     ...
     GET /api/travel-logs/{id}/tags*/@GetMapping("/{travelLogId}/tags")
    public ResponseEntity<?> getTags(@AuthenticationPrincipal String username, @PathVariable Long travelLogId) {
